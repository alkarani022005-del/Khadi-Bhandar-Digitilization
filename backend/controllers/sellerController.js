...
const addProduct = async (req, res) => {
  try {
    ...
    const categories = req.body.categories?.length ? req.body.categories : (req.body.category ? [req.body.category] : []);
    const category   = categories[0] || req.body.category || 'General';
...
const updateProduct = async (req, res) => {
  try {
    ...
    // Sync category fields
    const categories = req.body.categories?.length ? req.body.categories : (req.body.category ? [req.body.category] : product.categories);
    const category   = categories[0] || req.body.category || product.category;
