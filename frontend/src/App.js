...
const HS = {
  section: { background: '#fff', borderRadius: 4, padding: 20, marginBottom: 16 },
  sectionTitle: { fontSize: 20, fontWeight: 'bold', color: '#212121', marginBottom: 16, paddingBottom: 12, borderBottom: '1px solid #f0f0f0' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 12 },
  categoryGrid: { display: 'grid', gridTemplateColumns: 'repeat(8, 1fr)', gap: 12 },
  categoryChip: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, padding: '16px 8px', background: '#fce4ec', borderRadius: 8, textDecoration: 'none' },
  footer: { background: '#212121', marginTop: 24 },
  footerGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 32 },
  footerTitle: { color: '#fff', fontWeight: 'bold', fontSize: 16, marginBottom: 12 },
  footerHeading: { color: '#e91e63', fontWeight: 'bold', fontSize: 14, marginBottom: 12 },
  footerText: { color: '#9e9e9e', fontSize: 13, marginBottom: 6 },
  footerLink: { color: '#9e9e9e', fontSize: 13, marginBottom: 6, display: 'block', textDecoration: 'none' },
  footerBottom: { borderTop: '1px solid #424242', marginTop: 32, paddingTop: 20, textAlign: 'center', color: '#757575', fontSize: 13 },
};
